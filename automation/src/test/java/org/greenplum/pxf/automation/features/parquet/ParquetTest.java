...
public class ParquetTest extends BaseFeature {
    ...
    public void parquetReadPrimitives() throws Exception {
        ...
        prepareReadableTable(PXF_PARQUET_TABLE, PARQUET_TABLE_COLUMNS, hdfsPath + PARQUET_PRIMITIVE_TYPES);
    ...
    public void parquetReadSubset() throws Exception {
        prepareReadableTable("pxf_parquet_subset",
    ...
    public void parquetReadUndefinedPrecisionNumericFromAParquetFileGeneratedByHive() throws Exception {
        ...
        prepareReadableTable("pxf_parquet_read_undefined_precision_numeric",
    ...
    public void parquetReadNumericWithPrecisionAndScaleFromAParquetFileGeneratedByHive() throws Exception {
        prepareReadableTable("pxf_parquet_read_numeric",
    ...
    public void parquetPredicatePushDown() throws Exception {
        prepareReadableTable("parquet_types_hcfs_r", PARQUET_TYPES_COLUMNS, hdfsPath + PARQUET_TYPES);
    ...
    private void runWriteScenario(String writeTableName, String readTableName,
        ...
        exTable = new WritableExternalTable(writeTableName,
                ...
                protocol.getExternalTablePath(hdfs.getBasePath(), hdfsPath) + filename,
                "custom");
        exTable.setHost(pxfHost);
        exTable.setPort(pxfPort);
        exTable.setFormatter("pxfwritable_export");
        ...
        prepareReadableTable(readTableName, PARQUET_TABLE_COLUMNS, hdfsPath + filename);
        gpdb.runQuery("CREATE OR REPLACE VIEW parquet_view AS SELECT s1, s2, n1, d1, dc1, " +
                "CAST(tm AS TIMESTAMP WITH TIME ZONE) AT TIME ZONE 'PDT' as tm, " +
    ...
    private void prepareReadableTable(String name, String[] fields, String path) throws Exception {
        ProtocolEnum protocol = ProtocolUtils.getProtocol();
        exTable = new ReadableExternalTable(name,
                fields, protocol.getExternalTablePath(hdfs.getBasePath(), path), "custom");
        exTable.setHost(pxfHost);
        exTable.setPort(pxfPort);
        exTable.setFormatter("pxfwritable_import");
        exTable.setProfile(protocol.value() + ":parquet");
